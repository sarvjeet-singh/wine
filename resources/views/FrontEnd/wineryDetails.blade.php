                    ...
                    <div class="p-3 shadow rounded-4 bg-white">
                        ...
                        <div class="pt-3">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <strong
                                    class="fa-lg text-muted text-uppercase">{{ !empty($vendor->wineryMetadata->maxGroup->name) ? ucwords($vendor->wineryMetadata->maxGroup->name) : '' }}</strong>
                            </div>
                        </div>
                        @if ($vendor->policy != '')
...
@else
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        <div class="text-center">
            <p>You are younger than 18 years or you have not filled your date of birth.</p>
