        ...
        <div class="col-lg-6">
            <div class="property-box px-3">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3 mb-2">
                    <h5 class="theme-color fs-6 mb-0">{{ !empty($vendor->sub_category->name) ? $vendor->sub_category->name : '' }}</h5>
                    <div class="rating-star d-flex align-items-center"
                        data-rating="{{ $vendor->reviews->avg('rating') ?? 0.0 }}"></div>
                </div>
                <div class="property-name">
                    <p class="fw-bold">{{ $vendor->vendor_name }}</p>
                </div>
                ...
                <ul class="room-info-inner d-flex justify-content-between list-unstyled p-0 border-top pt-3 gap-3">
                    {{-- <li><span class="theme-color">$</span> Moderately High</li> --}}
                    {{-- <li>Max Group Size: 3-4 People</li> --}}
                </ul>
