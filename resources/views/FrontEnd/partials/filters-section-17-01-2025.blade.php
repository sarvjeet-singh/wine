        ...
        <div class="side-filter border rounded-3 p-sm-3">
            ...
            @if (isset($establishments) && count($establishments) > 0 && $vendor_type == 'excursion')
                <div class="filter-box mb-3">
                    ...
                    @endforeach
                </div> @endif @if ($vendor_type == 'winery')
                    @if (count($farmingPractices) > 0)
                        <div class="filter-box mb-3">
                            ...
                            @endforeach
                        </div> @endif @endif @if ($vendor_type == 'winery')
                            <div class="filter-box mb-3">
                                <h6>Sub-Region</h6>
                            ...
                            @if (count($tastingOptions) > 0)
                                <div class="filter-box mb-3">
                                    ...
                                    @foreach ($tastingOptions as $tastingOption)
                                        <div class="form-check">
                                            <input class="form-check-input filter" type="checkbox"
                                                name="tasting_options" value="{{ $tastingOption->id }}"
                                                id="{{ $tastingOption->slug }}">
                                            <label class="form-check-label" for="{{ $tastingOption->slug }}">
                                                {{ $tastingOption->name }}
                                            </label>
                                        </div>
                                    @endforeach
                                </div> @endif @endif @if ($vendor_type == 'accommodation')
                                    <div class="filter-box mb-3">
                                        <h6>Bedrooms</h6>
                                        <div class="form-check">
                                            <input class="form-check-input filter" type="checkbox" value="1"
                                                name="bedrooms" id="1Bedroom">
                                            <label class="form-check-label" for="1Bedroom"> 1 Bedroom(s) </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input filter" type="checkbox" value="2"
                                                name="bedrooms" id="2Bedrooms">
                                            <label class="form-check-label" for="2Bedrooms"> 2 Bedroom(s) </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input filter" type="checkbox" value="3"
                                                name="bedrooms" id="3Bedrooms">
                                            <label class="form-check-label" for="3Bedrooms"> 3 Bedroom(s) </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input filter" type="checkbox" value="4+"
                                                name="bedrooms" id="4Bedrooms">
                                    ...
                                    <div class="filter-box mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input filter" type="checkbox" value="2"
                                                name="person" id="1Person">
                                            <label class="form-check-label" for="1Persons"> 1 Bed / Sleeps 2 </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input filter" type="checkbox" value="4"
                                                name="person" id="4Persons">
                                            <label class="form-check-label" for="4Persons"> 2 Beds / Sleeps 4 </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input filter" type="checkbox" value="6"
                                                name="person" id="6Persons">
                                            <label class="form-check-label" for="6Persons"> 3 Beds / Sleeps 6 </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input filter" type="checkbox" value="8+"
                                                name="person" id="8Persons">
                                            <label class="form-check-label" for="8Persons"> 4+ Beds / Sleeps 8+
                                            </label>
                                        </div>
                                    </div>
                                    @endif @if ($vendor_type != 'winery' && $vendor_type != 'accommodation')
                                        <div class="filter-box mb-3">
                                            <h6>Cuisine</h6>
                                            @if (count($cuisines) > 0)
                                                @foreach ($cuisines as $cuisine)
                                                    <div class="form-check">
                                                        <input class="form-check-input filter" type="checkbox"
                                                            name="cuisines" value="{{ $cuisine->id }}"
                                                            id="{{ $cuisine->slug }}">
                                                ...
                                                @endforeach
                                            @endif
                                        </div> @endif @if ($vendor_type != 'accommodation')
                                            <div class="filter-box mb-3">
                                                <h6>Hours of Operation</h6> @php $daysOfWeek = ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday']; @endphp @foreach ($daysOfWeek as $day)
                                                    <div class="form-check">
                                                        <input class="form-check-input filter" type="checkbox"
                                                            name="days" value="{{ $day }}"
                                                            id="{{ $day }}">
                                        ...
                                        <div class="filter-box mb-3">
                                            <h6>Star Rating </h6>
                                            <div class="form-check">
                                                <input class="form-check-input filter" type="checkbox" name="rating"
                                                    value="1" id="1star">
