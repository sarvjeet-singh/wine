<div class="col-xl-2 col-md-3 col-sm-4">
    <div class="fixed-sidebar mb-sm-0 mb-4">
        ...
        <div class="side-filter border rounded-3 p-3">
                ...
                @if (count($subCategories) > 0)
                    @foreach ($subCategories as $subCategory)
                        <div class="form-check">
                            <input class="form-check-input filter" type="checkbox" name="vendor_sub_category"
            ...
            @if (isset($establishments) && count($establishments) > 0 && $vendor_type == 'excursion')
                <div class="filter-box mb-3">
                    <h6>Establishment/Facility</h6>
                    @foreach ($establishments as $establishment)
                        <div class="form-check">
                            <input class="form-check-input filter" type="checkbox" name="establishment"
                                value="{{ $establishment->id }}" id="{{ $establishment->slug }}">
            ...
            @if ($vendor_type == 'winery')
                @if (count($farmingPractices) > 0)
                    <div class="filter-box mb-3">
                        ...
                        @foreach ($farmingPractices as $farmingPractice)
                            <div class="form-check">
                                <input class="form-check-input filter" type="checkbox" name="farming_practices"
                                    value="{{ $farmingPractice->id }}" id="{{ $farmingPractice->slug }}">
                ...
                @endif
            @endif
            @if ($vendor_type != 'licensed' && $vendor_type != 'non-licensed')
                <div class="filter-box mb-3">
                    <h6>Sub-Region</h6>
                    @if (count($subRegions) > 0)
                        @foreach ($subRegions as $subRegion)
                            <div class="form-check">
                                <input class="form-check-input filter" type="checkbox" name="sub_region"
            ...
            <div class="filter-box mb-3">
                ...
                @foreach ($cities as $city)
                    <div class="form-check">
                        <input class="form-check-input filter" type="checkbox" name="city"
                            value="{{ $city }}" id="{{ $city }}">
                ...
                @if (count($tastingOptions) > 0)
                    <div class="filter-box mb-3">
                        ...
                        @foreach ($tastingOptions as $tastingOption)
                            <div class="form-check">
                                <input class="form-check-input filter" type="checkbox" name="tasting_options"
            ...
            @if ($vendor_type == 'accommodation')
                <div class="filter-box mb-3">
                    <h6>Bedrooms</h6>
                    <div class="form-check">
                        <input class="form-check-input filter" type="checkbox" value="1" name="bedrooms"
                            id="1Bedroom">
                    ...
                    <div class="form-check">
                        <input class="form-check-input filter" type="checkbox" value="2" name="bedrooms"
                            id="2Bedrooms">
                    ...
                    <div class="form-check">
                        <input class="form-check-input filter" type="checkbox" value="3" name="bedrooms"
                            id="3Bedrooms">
                    ...
                    <div class="form-check">
                        <input class="form-check-input filter" type="checkbox" value="4+" name="bedrooms"
                            id="4Bedrooms">
                ...
                <div class="filter-box mb-3">
                    <h6>Beds / Sleeps</h6>
                    <div class="form-check">
                        <input class="form-check-input filter" type="checkbox" value="2" name="person"
                            id="1Person">
                    ...
                    <div class="form-check">
                        <input class="form-check-input filter" type="checkbox" value="4" name="person"
                            id="4Persons">
                    ...
                    <div class="form-check">
                        <input class="form-check-input filter" type="checkbox" value="6" name="person"
                            id="6Persons">
                    ...
                    <div class="form-check">
                        <input class="form-check-input filter" type="checkbox" value="8+" name="person"
                            id="8Persons">
            ...
            @endif
            @if ($vendor_type != 'winery' && $vendor_type != 'accommodation')
                <div class="filter-box mb-3">
                    <h6>Cuisine</h6>
                    @if (count($cuisines) > 0)
                        @foreach ($cuisines as $cuisine)
                            <div class="form-check">
                                <input class="form-check-input filter" type="checkbox" name="cuisines"
            ...
            @if ($vendor_type != 'accommodation')
                <div class="filter-box mb-3">
                    ...
                    @foreach ($daysOfWeek as $day)
                        <div class="form-check">
                            <input class="form-check-input filter" type="checkbox" name="days"
                                value="{{ $day }}" id="{{ $day }}">
            ...
            <div class="filter-box mb-3">
                <h6>Star Rating </h6>
                <div class="form-check">
                    <input class="form-check-input filter" type="checkbox" name="rating" value="1"
                        id="1star">
                ...
                <div class="form-check">
                    <input class="form-check-input filter" type="checkbox" name="rating" value="2"
                        id="2star">
                ...
                <div class="form-check">
                    <input class="form-check-input filter" type="checkbox" name="rating" value="3"
                        id="3star">
                ...
                <div class="form-check">
                    <input class="form-check-input filter" type="checkbox" name="rating" value="4"
                        id="4star">
                ...
                <div class="form-check">
                    <input class="form-check-input filter" type="checkbox" name="rating" value="5"
                        id="5star">
            ...
            <div class="filter-box mb-3">
                <h6>Price Point</h6>
                <div class="form-check">
                    <input class="form-check-input filter" type="checkbox" value="least" name="price_point"
                        id="Least">
                ...
                <div class="form-check">
                    <input name="price_point" class="form-check-input filter" type="checkbox" value="low"
                        id="LowModerately">
                ...
                <div class="form-check">
                    <input name="price_point" class="form-check-input filter" type="checkbox" value="high"
                        id="ModeratelyHigh">
                ...
                <div class="form-check">
                    <input name="price_point" class="form-check-input filter" type="checkbox" value="expensive"
                        id="MostExpensive">
