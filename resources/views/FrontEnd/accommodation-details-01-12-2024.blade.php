                ...
                <div class="p-3 shadow rounded-4 bg-white">
                    ...
                    <div class="pt-1">
                        ...
                        <div class="d-flex justify-content-between border-top pt-2 mt-2">
                            <p class="fa-lg my-2 fw-bold text-capitalize lh-sm">Special request may be accommodated</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p class="fa-lg mb-0">Website: {!! $vendor->website ? '<a class="text-lowercase" href="' . $vendor->website . '" target="_blank">' . $vendor->website . '</a>' : 'N/A' !!}</p>
                        </div>
                    </div>
                    @if ($vendor->policy != '')
