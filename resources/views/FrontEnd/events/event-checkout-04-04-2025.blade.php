    ...
    <script>
        ...
        <div class="col-sm mb-sm-0 mb-3">
            <div class="form-floating">
                <input type="email" class="form-control" id="joinee_email_${rowCount}" name="joinee[${rowCount - 1}][email]" data-msg-required="Please enter your email" data-msg-email="Please enter a valid email address" required placeholder="Email">
