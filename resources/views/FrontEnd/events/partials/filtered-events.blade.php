<div class="row g-4 mb-3">
    <div class="col-12">
        <div class="event-head d-flex align-items-center justify-content-between gap-1 border rounded-3 px-3 py-2">
            <h3 class="mb-0 fs-4">
                {{ (count(request('date_filter', [])) === 1 && request('date_filter')[0] != 'date_range') ? ucfirst(request('date_filter')[0]) : 'Filtered' }} Events
            </h3>
        </div>
    </div>
