        ...
        <div class="container">
            <div class="inner-content">
                <ul class="list-unstyled d-flex justify-content-center align-items-center mb-0">
                    <li><a href="{{ route('excursion-listing') }}" class="text-decoration-none">Excursion</a></li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="fixed-sidebar mb-sm-0 mb-4">
                       ...
                       $ Least Expensive
                                ...
                                @php
                                    ...
                                    $cities = Vendor::where('vendor_type', 'excursion')->distinct()->pluck('city');
                                @endphp
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadMoreListings(resetPage = false, url = null, page = 1) {
                ...
                var requestUrl = url ? url : "{{ route('get.excursions') }}";
