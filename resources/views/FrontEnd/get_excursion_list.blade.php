        ...
        <div class="col-lg-6">
            <div class="property-box px-3">
                ...
                <ul class="room-info-inner d-flex justify-content-between list-unstyled p-0 border-top pt-3 gap-1">
                    <li>{{ !empty($vendor->excursionMetadata->maxGroup->name) ? $vendor->excursionMetadata->maxGroup->name : '' }}
                    </li>
                    <li>{{ !empty($vendor->excursionMetadata->establishments->name) ? $vendor->excursionMetadata->establishments->name : '' }}
                    </li>
                </ul>
