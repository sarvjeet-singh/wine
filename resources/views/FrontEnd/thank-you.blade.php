        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-8 text-center">
                    ...
                    @if (isset($order_id))
                        <p class="lead">Your booking order <strong>#{{ $order_id }}</strong> has been successfully
                            confirmed.</p>
                    @else
                    ...
                    <p>We appreciate your booking with Wine Country Weekends! A confirmation email has been sent to your
                    ...
                    <div class="my-4">
                        ...
                        @if ($orderType == 'accommodation')
                            <a href="{{ route('user.orderDetail', $order_id ?? 0) }}" class="btn view-order-btn mx-1">View
                                Order Details</a>
                        @elseif($orderType == 'event')
                        <a href="{{ route('user.event-orderDetail', $order_id ?? 0) }}" class="btn view-order-btn mx-1">View
                                Order Details</a>
                        @endif
                    </div>
