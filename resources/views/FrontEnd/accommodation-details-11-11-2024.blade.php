                    ...
                    <div class="card-body">
                        ...
                        <div class="property-feature">
                            ...
                            <ul
                                ...
                                <li><span class="theme-color"></span>{{ !empty($vendor->accommodationMetadata->bedrooms) ? $vendor->accommodationMetadata->bedrooms : '' }}</li>
                                <li>{{ !empty($vendor->accommodationMetadata->washrooms) ? $vendor->accommodationMetadata->washrooms : '' }}</li>
                                <li>{{ !empty($vendor->accommodationMetadata->beds) ? $vendor->accommodationMetadata->beds : '' }} / {{ !empty($vendor->accommodationMetadata->sleeps) ? $vendor->accommodationMetadata->sleeps : '' }}</li>
                        ...
                        @if (
                            ...
                            <form method="post" id="process_payment" action="{{ route('checkout.process') }}">
                                ...
                                <div class="col-lg-12" id="datepicker-container">
            ...
            <div class="col-lg-4 ">
                <div class="p-3 shadow rounded-4 bg-white">
                    ...
                    <div class="pt-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <span class="fa-lg">Rate:</span>
                            <strong class="fa-lg text-muted">${{ $vendor->pricing->current_rate ?? 0 }}/Night</strong>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="fa-lg">Booking Minimum:</span>
                            <strong
                                class="fa-lg text-muted">{{ !empty($vendor->accommodationMetadata->booking_minimum) ? $vendor->accommodationMetadata->booking_minimum : 0 }}/Night</strong>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="fa-lg">Booking Maximum:</span>
                            <strong
                                class="fa-lg text-muted">{{ !empty($vendor->accommodationMetadata->booking_maximum) ? $vendor->accommodationMetadata->booking_maximum : 0 }}/Night</strong>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="fa-lg">Check-In After:</span>
                            <strong
                                class="fa-lg text-muted text-uppercase">{{ !empty($vendor->accommodationMetadata->checkin_start_time) ? $vendor->accommodationMetadata->checkin_start_time : 0 }}</strong>
                        </div>
                        <div class="d-flex  justify-content-between">
                            <span class="fa-lg">Check-Out Before:</span>
                            <strong
                                class="fa-lg text-muted text-uppercase">{{ !empty($vendor->accommodationMetadata->checkout_time) ? $vendor->accommodationMetadata->checkout_time : 0 }}</strong>
                        </div>
                    </div>
                    @if ($vendor->policy != '')
                ...
                <div class="modal-body p-4">
                    <div class="row">
                        @if (count($amenities) > 0)
                            ...
                            <div class="col-md-6">
                                <h6 class="fw-bold text-center">Basic</h6>
                            ...
                            <div class="col-md-6">
                                <h6 class="fw-bold text-center">Premium</h6>
                                <ul class="list-unstyled">
                                    @foreach ($amenities as $key => $amenity)
