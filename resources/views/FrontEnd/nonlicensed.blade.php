        ...
        <div class="container">
            <div class="inner-content">
                <ul class="list-unstyled d-flex justify-content-center align-items-center mb-0">
                    <li><a href="{{ route('excursion-listing') }}" class="text-decoration-none"> Non Licensed</a></li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="fixed-sidebar mb-sm-0 mb-4">
                        ...
                        <div class="side-filter border rounded-3 p-3">
                            <div class="filter-box mb-3">
                                <h6>Non-Licensed Sub-Category</h6>
						...
						<h6>Sub-Regions</h6>
						<div class="form-check">
						  <input class="form-check-input" type="checkbox" value="" id="NiagaraFalls">
						  <label class="form-check-label" for="NiagaraFalls">
						    Niagara Falls
						  </label>
						</div>
						<div class="form-check">
						  <input class="form-check-input" type="checkbox" value="" id="Niagara-on-the-Lake">
						  <label class="form-check-label" for="Niagara-on-the-Lake">
						    Niagara-on-the-Lake
						  </label>
						</div>
						<div class="form-check">
						  <input class="form-check-input" type="checkbox" value="" id="NiagaraEscarpment">
						  <label class="form-check-label" for="NiagaraEscarpment">
						    Niagara Escarpment
						  </label>
						</div>
						<div class="form-check">
						  <input class="form-check-input" type="checkbox" value="" id="SouthEscarpment">
						  <label class="form-check-label" for="SouthEscarpment">
						    South Escarpment 
						  </label>
						</div>
						<div class="form-check">
						  <input class="form-check-input" type="checkbox" value="" id="FortErie">
						  <label class="form-check-label" for="FortErie">
						    Fort Erie
						  </label>
						</div>
					</div> --}}
                            ...
                            <div class="filter-box mb-3">
                               ...
                               $ Least Expensive
                                ...
                                @php
                                    ...
                                    $cities = Vendor::where('vendor_type', 'non-licensed')->distinct()->pluck('city');
                                @endphp
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadMoreListings(resetPage = false, url = null, page = 1) {
                ...
                var requestUrl = url ? url : "{{ route('get.non-licensed') }}";
