...
@section('content')
    ...
    @if (!Auth::check())
        <!-- Login Popup -->
        <div class="modal fade enquiry-modal loginPopup" id="enquiryModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-6 mb-lg-0 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input id="datepicker" class="form-control" name="check_in" type="date"
                                            required min="2024-06-25">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="wineries_activity_sec check-list">
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            <li>
                                                <input type="checkbox" name="vendor_sub_category[]"
                                                    id="wineries_activities" value="Destination"><label
                                                    for="wineries_activities">Destination </label>
                                            </li>
                                            <li>
                                                <input type="checkbox" name="vendor_sub_category[]"
                                                    id="wineries_activities1" value="Vineyard"><label
                                                    for="wineries_activities1">Vineyard</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" name="vendor_sub_category[]"
                                                    id="wineries_activities2" value="Cellar"><label
                                                    for="wineries_activities2">Cellar</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" name="vendor_sub_category[]"
                                                    id="wineries_activities3" value="Farm"><label
                                                    for="wineries_activities3">Farm</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" name="vendor_sub_category[]"
                                                    id="wineries_activities4" value="Micro / Urban"><label
                                                    for="wineries_activities4">Micro /
                                                    Urban</label>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <li>
                                                <input type="checkbox" name="experience_type[]" id="wineries_activities6"
                                                    value="Tasting w/ Pairing"><label for="wineries_activities6">Tasting
                                                    w/
                                                    Pairings</label>
                                            </li>
                                            <li>
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <li>
                                                <input type="checkbox" name="group_type[]" id="wineries_activities9"
                                                    value="Private / Personalized"><label
                                                    for="wineries_activities9">Private /
                                                    Individual</label>
                                            </li>
                                        </ul>
                                    </div>
