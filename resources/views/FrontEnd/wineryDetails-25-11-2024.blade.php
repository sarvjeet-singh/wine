                        ...
                        <div class="card-body">
                            ...
                            <div class="property-feature">
                                ...
                                <ul
                                    ...
                                    <li>{{ $vendor->wineryMetadata->maxGroup->name ?? '' }}</li>
                                                ...
                                                <div class="tab-pane fade @if ($key == 0) show active @endif"
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        ...
                                                        <p class="fw-bold theme-color mb-0">$
                                                            {{ $experience->upgradefee }}{{ $experience->currenttype }}
                                                        </p>
                                                    </div>
                        ...
                        @if ($vendor->policy != '')
                            ...
                            @if ($vendor->policy == 'partial')
                                <p>A full refund minus transaction fees will be issued upon request up to 7 days prior to
                                    the
                                    check-in date indicated. No refund will be issued for cancellations that fall within
                                    that
                                    7-day period prior to the check-in date. A credit or rain cheque may be issued to guests
                                    at
                    ...
                    @foreach ($wines as $wine)
                        <div class="wine-item p-3">
                            ...
                            <div class="wine-info text-center mt-3">
                                ...
                                <p class="wine-price fw-bold theme-color">${{ $wine->price ?? '' }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
...
@else
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        <div class="text-center">
            <div class="mb-3">
                <img width="80px" src="{{ asset('images/no-alcohol.png') }}" class="img-fluid" />
            </div>
            <h3 class="fs-5 fw-bold mb-2 fs-5 text-capitalize">Please update your date of birth in your profile.</h3>
            <h4 class="fs-5 fw-bold fs-6 text-capitalize">To verify your age and access this page.</h4>
            <p class="f-15">You must be at least 18 years old to view this page.</p>
            <a href="{{ route('user-settings') }}" class="btn btn-primary">Redirect to Profile Page</a>
        </div>
    </div>
    @endif
@endsection
