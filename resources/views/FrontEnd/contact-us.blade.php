            ...
            <div class="row align-items-center g-sm-5 g-4">
                <div class="col-lg-6">
                    <div class="sec-content">
                        <p>At Wine Country Weekends we don’t typically hire, we collaborate. We believe that the whole is
                            greater than the sum of its parts and we are always on the lookout for new talent. Join our team
                            of free ranging entrepreneur types.</p>
                        <p>Mind blowing stuff? Maybe but if you can wrap your head around the concept, hit us up. Pitch us
                            on how what you do, will make what we do, better. If we smell what you’re cooking, we may offer
                            you a seat at our table.</p>
                    </div>
                </div>
                <div class="col-lg-6">
