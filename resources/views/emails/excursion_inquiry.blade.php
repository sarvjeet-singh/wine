        ...
        <div class="section" style="background-color: #f9f9f9;padding: 20px;border-radius: 15px;">
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div>
                    ...
                    {{-- <div style="margin-bottom: 10px;"><strong>Establishment/Facility: </strong> <span>{{$inquiryData['vendor']->establishment ?? ''}}</span>
                    </div> --}}
            ...
            <div class="section">
                ...
                <table class="details-table">
                    ...
                    <tr>
                        <th width="50%">In what city/town would you prefer to be situated?</th>
                        <td width="50%">{{$inquiryData['inquiry']['preferred_excursions'] ?? ''}}</td>
                    </tr>
                    <tr>
