    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td>
                        <p style="font-weight: bold;margin: 4px 0;">Will you require accommodations and if so, what is your preferred type?</p>
                        <p style="font-weight: 400;margin: 4px 0;">{{ $validated['preferred_accommodation'] }}</p>
                    </td>                  
                </tr> 
                <tr>
                   <td>
                        <p style="font-weight: bold;margin: 4px 0;">What if any, type(s) of excursions are you considering?</p>
                        <p style="font-weight: 400;margin: 4px 0;">{{ implode(', ', $validated['excursion_activities']) }}</p>
                    </td>
                </tr>
                <tr>                
                    <td>
