    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td>
                        <p style="font-weight: bold;margin: 4px 0;">What is your preferred type of winery</p>
                        <p style="font-weight: 400;margin: 4px 0;">{{ implode(', ', $validated['vendor_sub_category']) }}</p>
                    </td>                  
                </tr> 
                <tr>
                   <td>
                        <p style="font-weight: bold;margin: 4px 0;">Please indicate the type of experience you prefer?</p>
                        <p style="font-weight: 400;margin: 4px 0;"> {{ implode(', ', $validated['experience_type']) }}</p>
                    </td>
                </tr>
                <tr>                
                    <td>
                        <p style="font-weight: bold;margin: 4px 0;">What type of group orientation would you prefer?</p>
                        <p style="font-weight: 400;margin: 4px 0;">{{ implode(', ', $validated['group_type']) }}</p>
                    </td>
                </tr>
                <tr>
                    <td>
