                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-floating">
                                                <input type="text" class="form-control currency-field " value=""
                                                    name="experience[0][upgradefee]" placeholder="Enter Upgrade fee">
                                                <label for="floatingInputGroup1">Admittance</label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="profile-img-sec">
                                    <label for="profileImage" class="position-relative">
                                        <img id="profilePreview" src="/images/VendorImages/Cameo Cottage/vu8d6HrhLW.png"
                                            class="profile-img rounded-3" alt="Profile Image"
                                            style="width: 200px; height: 130px; object-fit: cover; border: 1px solid #408a95;">
                                        <p
                                            style="font-size: 14px;margin-top: 10px;color: #408a95;cursor: pointer;text-align: center;">
                                            <i class="fa-solid fa-arrow-up-from-bracket"></i> Upload Media</p>
                                    </label>
