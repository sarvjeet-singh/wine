                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <label for="farming_practices" class="form-label fw-bold">Farming
                                                Practices</label>
                                            <select class="form-select" name="farming_practices" id="farming_practices">
                ...
                <div class="information-box">
                    ...
                    <div class="information-box-body">
                        <div class="subscription-plan-sec my-4">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="plan-inner bg-white p-4">
                                        <h3 class="fw-bold fs-5 text-center theme-color">Monthly</h3>
                                        <h2 class="fw-bold text-center mb-3">$99 <span class="fw-normal fs-6">/per month</span></h2>
                                        <p class="mb-2">This Plan Includes:</p>
                                        <ul class="list-unstyled p-0 mb-4">
                                            <li class="position-relative mb-3">Dolor sit amet consectetur</li>
                                            <li class="position-relative mb-3">Voluptate unde sed nesciunt</li>
                                            <li class="position-relative mb-3">Perspiciatis consectetur porro</li>
                                            <li class="position-relative mb-3">Batae alias ducimus perferendis eveniet minima</li>
                                            <li class="position-relative mb-3">Unde sed nesciunt</li>
                                        </ul>
                                        <div class="buy-btn text-center">
                                            <a href="#" class="btn wine-btn">Buy Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="plan-inner bg-white p-4">
                                        ...
                                        <h2 class="fw-bold text-center mb-3">$999 <span class="fw-normal fs-6">/quarterly</span></h2>
                                        <p class="mb-2">This Plan Includes:</p>
                                        <ul class="list-unstyled p-0 mb-4">
                                            <li class="position-relative mb-3">Dolor sit amet consectetur</li>
                                            <li class="position-relative mb-3">Voluptate unde sed nesciunt</li>
                                ...
                                <div class="col-lg-4">
                                    <div class="plan-inner bg-white p-4">
                                        <h3 class="fw-bold fs-5 text-center theme-color">Annually</h3>
                                        <h2 class="fw-bold text-center mb-3">$9999 <span class="fw-normal fs-6">/per year</span></h2>
                                        <p class="mb-2">This Plan Includes:</p>
                                        <ul class="list-unstyled p-0 mb-4">
                                            <li class="position-relative mb-3">Dolor sit amet consectetur</li>
                                            <li class="position-relative mb-3">Voluptate unde sed nesciunt</li>
