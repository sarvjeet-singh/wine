...
@section('content')
    ...
    <div class="col right-side">
        <div class="row">
            <div class="col-sm-12">
                <div class="mb-3">
                    <button class="btn wine-btn px-4 d-flex align-items-center gap-2" onclick="window.history.back()">
                        <i class="fa-solid fa-arrow-left"></i>
                    </button>
                </div>
                <div class="information-box p-0">
                    <div class="information-box-head">
                        <div class="box-head-heading d-flex"> <span
                                class="box-head-label theme-color fw-bold">{{ $wine->series }}
                                Details</span> </div>
                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="wine-info">
                                        ...
                                        <div class="wine-notes my-3 py-3 border-top border-bottom">
                                            <p class="my-1 p-2"><span class="theme-color fw-bold">Bottle Notes:
                                                </span></p>
                                            <p class="mb-0">
