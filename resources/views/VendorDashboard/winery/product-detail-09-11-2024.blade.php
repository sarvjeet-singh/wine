                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="wine-info px-3">
                                        ...
                                        <div class="wine-feature position-relative mt-4">
                                            <img src="{{ asset('images/wine-bg-img.png') }}" class="d-lg-block d-none">
                                            <table>
                                                <tbody>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th><span class="theme-color fw-bold">Varietal/Bland:</span></th>
                                                        @php
