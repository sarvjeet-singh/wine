                                        ...
                                        <div class="add-wines-cart d-flex align-items-center gap-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-check form-check-inline">
                                                  <input class="form-check-input p-0" type="radio" name="wineOptions" id="inlineRadio1" value="botal">
                                                  <label class="form-check-label" for="inlineRadio1">
                                                      Bottle
                                                  </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                  <input class="form-check-input p-0" type="radio" name="wineOptions" id="inlineRadio2" value="case">
                                            ...
                                            <div class="cart-btn">
                                                ...
                                                @else
                                                    <a href="javascript:void(0)" class="btn wine-btn disabled">Add to Cart</a>
                                                @endif
                                            </div>
                                            ...
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>{{ ucfirst($wine->region) }}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <th><span class="theme-color fw-bold">Sub-Region:</span></th>
                                                        <td><span>{{ $wine->sub_region }}</span></td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="wine-info mt-3">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center gap-2 flex-column ">
                                                <div class="add-wines-cart d-flex align-items-center">
                                                    <div class="form-check form-check-inline">
                                                      <input class="form-check-input p-0" type="radio" name="wineOptions{{ $loop->index }}" id="inlineRadio1_{{ $loop->index }}" value="botal">
                                                      <label class="form-check-label" for="inlineRadio1_{{ $loop->index }}">
                                                          Bottle
                                                      </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                      <input class="form-check-input p-0" type="radio" name="wineOptions{{ $loop->index }}" id="inlineRadio2_{{ $loop->index }}" value="case">
                                                      <label class="form-check-label d-flex align-items-center" for="inlineRadio2_{{ $loop->index }}">
                                                        Case
                                                      </label>
                                                    </div>
                                                </div>
                                                <div class="cart-btn text-end"> <a href="javascript:void(0)"
                                                        data-id="{{ $wine->id }}" class="btn wine-btn add-to-cart-slider">Add to Cart</a>
                                                </div>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", ".add-to-cart", function() {
                ...
                var quantity_type = $(this).data('type');
                var quantity = $(this).parents('.d-flex').find('.input-group .quantity').val();
