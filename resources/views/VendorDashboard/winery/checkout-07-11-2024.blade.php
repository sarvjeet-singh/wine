...
@section('js')
    ...
    <script>
            ...
            fetch('{{ route('confirm-payment', $vendorid) }}', {
                ...
                .then((data) => {
                    if (data.success) {
                        ...
                        // Use SweetAlert2 for confirmation success message
                        Swal.fire({
        ...
        function resetCheckoutForm() {
            ...
            document.getElementById("checkout-form").reset(); // Adjust the ID to match your form
        }

        $("#pay-button").on("click", function() {
            if ($("#checkout-form").valid()) {
                const $payButton = $(this);
                const originalButtonText = $payButton.html(); // Save the original button text
