                                        ...
                                        <div class="col-12">
                                            <div class="profile-img-sec text-center">
                                                <label for="profileImage" class="position-relative">
                                                    <img id="profilePreview" src="/images/UserProfile/default-profile.png" class="profile-img rounded-circle" style="width: 120px; height: 120px; min-height: 120px; object-fit: cover; border: 2px solid #b7a35f;cursor: pointer;">
