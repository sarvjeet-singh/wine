<div class="left-navbar-mobile d-lg-none d-flex align-items-center justify-content-between py-2">
  ...
  <div class="container-fluid justify-content-end">
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#leftNavbarMobile" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
          ...
          <li class="nav-item {{ request()->is('user-dashboard*') ? 'active' : '' }}">
              <a href="{{route('user-dashboard')}}" class="nav-link align-middle px-sm-2 px-3">
                  <img src="{{asset('images/icons/profile_icon_grey.png')}}" data-image="{{asset('images/icons/profile_icon') }}">
          ...
          <li class="nav-item {{ request()->is('user-review-submit*') ? 'active' : '' }}">
              <a href="{{route('user-review-submit')}}" class="nav-link px-sm-2 px-3 align-middle">
                  <img src="{{asset('images/icons/rating_icon_grey.png')}}" data-image="{{asset('images/icons/rating_icon') }}">
          ...
          <li class="nav-item {{ request()->is('manage-review*') ? 'active' : '' }}">
              <a href="{{route('manage-review')}}" class="nav-link px-sm-2 px-3 align-middle">
                  <img src="{{asset('images/icons/manage_reviews_icon_grey.png')}}" data-image="{{asset('images/icons/manage_reviews_icon') }}">
          ...
          <li class="nav-item {{ request()->is('user/inquiries*') ? 'active' : '' }}">
            <a href="{{route('user-inquiries')}}" class="nav-link px-sm-2 px-3 align-middle">
                <img src="{{asset('images/icons/tranctions_icon_grey.png')}}" data-image="{{asset('images/icons/tranctions_icon') }}">
          ...
          <li class="nav-item {{ request()->is('user-faq*') ? 'active' : '' }}">
              <a href="{{route('user-faq')}}" class="nav-link px-sm-2 px-3 align-middle">
                  <img src="{{asset('images/icons/faq_icon_grey.png')}}" data-image="{{asset('images/icons/faq_icon') }}">
          ...
          <li class="nav-item">
              <a href="javascripr:void(0)" class="nav-link px-sm-2 px-3 align-middle" data-bs-toggle="modal" data-bs-target="#logoutModal">
                  <img src="{{asset('images/icons/logout_icon_grey.png')}}" data-image="{{asset('images/icons/logout_icon') }}">
