                                                ...
                                                <div class="row gx-5 gy-2">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                                            ...
                                                            <p class="mb-0">{{ $order->vendor->sub_region->name ?? '' }}</p>
                                                ...
                                                <div class="guest-details">
                                                    <div class="sec-head border-bottom px-4 py-3">
                                                        <h3 class="fw-bold mb-0">
                                                            <i class="fa-solid fa-user-group"></i> Guest Details
                                                        </h3>
                                                    </div>
                                        ...
                                        <div class="total-cost">
                                            ...
                                            <div class="px-4 py-3">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-2">
                                                    ...
                                                    <p class="fw-bold mb-0">${{ number_format($order->sub_total, 2, '.', '') }}
                                                    </p>
            ...
            async function createPaymentIntent(paymentMethodId, order_id) {
                try {
                    const response = await fetch(
                        "{{ route('customer.create-payment-intent', Auth::guard('customer')->user()->id) }}", {
                            method: 'POST',
                            headers: {
                                "Content-Type": "application/json",
                                "X-CSRF-Token": $('meta[name="csrf-token"]').attr('content'),
