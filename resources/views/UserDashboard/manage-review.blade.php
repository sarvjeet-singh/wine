                        ...
                        <tbody>
                            @if ($reviews)
                                @foreach ($reviews as $key => $review)
                                    <tr>
                                        <td
                                            class="{{ $review->review_status == 0 ? 'status-pending' : ($review->review_status == 1 ? 'status-approved' : 'status-declined') }}">
                                            {{ $review->review_status == 0 ? 'Pending' : ($review->review_status == 1 ? 'Approved' : 'Declined') }}
                                        </td>
