			...
			<div class="row g-sm-3 g-2 mb-3">
				<div class="col-md-12">
					...
					<div class="sub-type-radio">
						<div class="d-flex align-items-baseline gap-2">
							<input class="form-check-input @error('vendor_sub_category') is-invalid @enderror" type="radio" name="vendor_sub_category" id="restaurant" value="Restaurant [Culinary]" {{ old('vendor_sub_category') == 'Restaurant [Culinary]' ? 'checked' : '' }}>
							<label class="form-check-label" for="Restaurant">Restaurant [Culinary]</label>
						</div>
						<div class="d-flex align-items-baseline gap-2">
							<input class="form-check-input @error('vendor_sub_category') is-invalid @enderror" type="radio" name="vendor_sub_category" id="bar-pub" value="Bar / Pub [Culinary]" {{ old('vendor_sub_category') == 'Bar / Pub [Culinary]' ? 'checked' : '' }}>
							<label class="form-check-label" for="Bar">Bar / Pub [Culinary]</label>
						</div>
						<div class="d-flex align-items-baseline gap-2">
							<input class="form-check-input @error('vendor_sub_category') is-invalid @enderror" type="radio" name="vendor_sub_category" id="Brew-Pub" value="Brew Pub [Culinary]" {{ old('vendor_sub_category') == 'Brew Pub [Culinary]' ? 'checked' : '' }}>
							<label class="form-check-label" for="Brew-Pub">Brew Pub [Culinary]</label>
						</div>
						<div class="d-flex align-items-baseline gap-2">
							<input class="form-check-input @error('vendor_sub_category') is-invalid @enderror" type="radio" name="vendor_sub_category" id="lounge" value="Lounge / Night Club [Adult Entertainment]" {{ old('vendor_sub_category') == 'Lounge / Night Club [Adult Entertainment]' ? 'checked' : '' }}>
							<label class="form-check-label" for="Lounge">Lounge / Night Club [Adult Entertainment]</label>
						</div>
						<div class="d-flex align-items-baseline gap-2">
							<input class="form-check-input @error('vendor_sub_category') is-invalid @enderror" type="radio" name="vendor_sub_category" id="theatrevenue" value="Theatre / Venue [Family or Adult]" {{ old('vendor_sub_category') == 'Theatre / Venue [Family or Adult]' ? 'checked' : '' }}>
							<label class="form-check-label" for="Theatre / Venue">Theatre / Venue</label>
						</div>
						<div class="d-flex align-items-baseline gap-2">
							<input class="form-check-input @error('vendor_sub_category') is-invalid @enderror" type="radio" name="vendor_sub_category" id="Golf-Country-Club" value="Golf & Country Club [Sport & Adventure]" {{ old('vendor_sub_category') == 'Golf & Country Club [Sport & Adventure]' ? 'checked' : '' }}>
							<label class="form-check-label" for="Golf-Country-Club">Golf & Country Club [Sport & Adventure]</label>
						</div>
					</div>	
