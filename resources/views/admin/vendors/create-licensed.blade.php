...
@section('title', (!empty($vendor) ? 'Edit' : 'Create') . ' Licensed')
@section('css')
                            ...
                            <div class="information-box mb-3">
                                <div class="info-head p-3">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="text-white">Licensed Details</div>
                                    </div>
                                </div>
                                <div class="m-3 pb-4">
                                    <div class="row g-4">
                                        ...
                                        {{-- <div class="col-md-6">
                                            <div>
                                                ...
                                                <select class="form-select" name="farming_practices"
                                                    ...
                                                    @foreach ($farming_practices as $farming_practice)
