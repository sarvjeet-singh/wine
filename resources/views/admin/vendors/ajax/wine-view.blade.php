...
<div class="modal-body p-4">
    ...
    <form class="row g-3" id="vendorWineFormEdit"
        action="{{ route('vendor-wines.update', ['id' => $wine->id, 'vendor_id' => $vendor->id]) }}" method="POST"
        ...
        <div class="col-12 text-center">
            ...
            <button type="submit" data-bs-dismiss="modal" class="btn theme-btn w-25 px-3">Close</button>
            ...
            $('#vendorWineFormEdit').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        ...
                        url: '{{ route('vendor-wines.update', ['id' => $wine->id, 'vendorid' => $vendor->id]) }}',
