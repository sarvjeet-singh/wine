        ...
        <div class="container">
            <div class="inner-content">
                <ul class="list-unstyled d-flex justify-content-between align-items-center mb-0">
                    <li><a href="/accommodations" class="text-decoration-none"><i class="fa-solid fa-building"></i></a></li>
                    <li><a href="/excursion" class="text-decoration-none"><i class="fa-solid fa-people-group"></i></a></li>
                    <li><a href="/wineries" class="text-decoration-none"><i class="fa-solid fa-wine-glass"></i></a></li>
                    <li><a href="/events" class="text-decoration-none"><i class="fa-solid fa-calendar-days"></i></a></li>
                </ul>
            </div>
        </div>
    </section>
