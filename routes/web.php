...
Route::get('/shop/wines/{shopid}', [ShopController::class, 'products'])->name('frontend-shop.wines');
Route::get('/shop/wine-detail/{id}/{shopid}', [ShopController::class, 'productDetail'])->name('frontend-shop.wine-detail');
