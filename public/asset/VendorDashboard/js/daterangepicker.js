...
!(function (t, e) {
    ...
    var a = function (a, i, s) {
        ...
        if (
            ...
            "boolean" == typeof i.MobileCalendar && (this.MobileCalendar = i.MobileCalendar),
        ...
        if (void 0 === i.startDate && void 0 === i.endDate && e(this.element).is(":text")) {
            var o = e(this.element).val(),
                l = o.split(this.locale.separator);
            (h = c = null),
                2 == l.length ? ((h = t(l[0], this.locale.format)), (c = t(l[1], this.locale.format))) : this.singleDatePicker && "" !== o && ((h = t(o, this.locale.format)), (c = t(o, this.locale.format))),
                null !== h && null !== c && (this.setStartDate(h), this.setEndDate(c));
        }
        if ("object" == typeof i.ranges) {
            for (d in i.ranges) {
                (h = "string" == typeof i.ranges[d][0] ? t(i.ranges[d][0], this.locale.format) : t(i.ranges[d][0])),
                    (c = "string" == typeof i.ranges[d][1] ? t(i.ranges[d][1], this.locale.format) : t(i.ranges[d][1])),
                    this.minDate && h.isBefore(this.minDate) && (h = this.minDate.clone());
                var h,
                    c,
                    d,
                    m,
                    p = this.maxDate;
                this.maxSpan && p && h.clone().add(this.maxSpan).isAfter(p) && (p = h.clone().add(this.maxSpan)),
                    p && c.isAfter(p) && (c = p.clone()),
                    (this.minDate && c.isBefore(this.minDate, this.timepicker ? "minute" : "day")) ||
                        (p && h.isAfter(p, this.timepicker ? "minute" : "day")) ||
                        (((m = document.createElement("textarea")).innerHTML = d), (n = m.value), (this.ranges[n] = [h, c]));
            }
            var f = "<ul>";
            for (d in this.ranges) f += '<li data-range-key="' + d + '">' + d + "</li>";
        ...
        "function" == typeof s && (this.callback = s),
            ...
            this.singleDatePicker &&
                ...
                this.container.find(".drp-calendar.center").hide(),
    ...
    return (
        (a.prototype = {
            ...
            updateMonthsInView: function () {
                if (this.endDate) {
                    ...
                    this.leftCalendar.month.format("YYYY-MM") != this.startDate.format("YYYY-MM") &&
                        this.centerCalendar.month.format("YYYY-MM") != this.startDate.format("YYYY-MM") &&
                ...
                this.maxDate &&
                    ...
                    ((this.rightCalendar.month = this.maxDate.clone().date(2).subtract(0, "month")), 
                ...
                this.timePicker &&
                    (this.endDate
                        ? ((t = parseInt(this.container.find(".left .hourselect").val(), 10)),
                          isNaN((e = parseInt(this.container.find(".left .minuteselect").val(), 10))) && (e = parseInt(this.container.find(".left .minuteselect option:last").val(), 10)),
                        ...
                        : ((t = parseInt(this.container.find(".right .hourselect").val(), 10)),
                          isNaN((e = parseInt(this.container.find(".right .minuteselect").val(), 10))) && (e = parseInt(this.container.find(".right .minuteselect option:last").val(), 10)),
                    ...
                    this.centerCalendar.month.hour(t).minute(e).second(a),
            ...
            renderCalendar: function (a) {
                var i,
                    s = (i = "left" == a ? this.leftCalendar : "center" == a ? this.centerCalendar : this.rightCalendar).month.month(),
                    n = i.month.year(),
                    r = i.month.hour(),
                    o = i.month.minute(),
                    l = i.month.second(),
                ...
                for (var y = t([p, m, g, 12, o, l]), k = ((D = 0), 0), b = 0; D < 42; D++, k++, y = t(y).add(24, "hour"))
                    D > 0 && k % 7 == 0 && ((k = 0), b++),
                        ...
                        this.minDate && i[b][k].format("YYYY-MM-DD") == this.minDate.format("YYYY-MM-DD") && i[b][k].isBefore(this.minDate) && "center" == a && (i[b][k] = this.minDate.clone()),
                ...
                "left" == a ? (this.leftCalendar.calendar = i) : "center" == a ? (this.centerCalendar.calendar = i) : (this.rightCalendar.calendar = i);
                ...
                (Y += "<thead>"),
                    ...
                    (v && !v.isBefore(i.firstDay)) || (this.linkedCalendars && "left" != a) ? (Y += "<th></th><th></th>") : (Y += '<th></th><th class="prev available"><svg width="15" height="17" viewBox="0 0 19 21" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.310013 10.42L18.04 20.65V0.189941L0.310013 10.42Z" fill="white"/></svg></th>');
                var _ = this.locale.monthNames[i[1][1].month()] + i[1][1].format(" YYYY");
                if (this.showDropdowns) {
                    for (var P = i[1][1].month(), w = i[1][1].year(), x = (C && C.year()) || this.maxYear, M = (v && v.year()) || this.minYear, S = w == M, B = w == x, I = '<select class="monthselect">', L = 0; L < 12; L++)
                        (!S || (v && L >= v.month())) && (!B || (C && L <= C.month()))
                            ? (I += "<option value='" + L + "'" + (L === P ? " selected='selected'" : "") + ">" + this.locale.monthNames[L] + "</option>")
                            : (I += "<option value='" + L + "'" + (L === P ? " selected='selected'" : "") + " disabled='disabled'>" + this.locale.monthNames[L] + "</option>");
                    I += "</select>";
                    for (var A = '<select class="yearselect">', E = M; E <= x; E++) A += '<option value="' + E + '"' + (E === w ? ' selected="selected"' : "") + ">" + E + "</option>";
                    _ = I + (A += "</select>");
                }
                if (
                    ((Y += '<th colspan="3" class="month">' + _ + "</th>"),
                    (C && !C.isAfter(i.lastDay)) || (this.linkedCalendars && "right" != a && !this.MobileCalendar) ? (Y += "<th></th><th></th>") : (Y += '<th class="next available"><svg width="15" height="17" viewBox="0 0 19 21" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18.66 10.3101L0.939941 20.55V0.0799561L18.66 10.3101Z" fill="white"/></svg></th><th></th>'),
                    (Y += "</tr>"),
                    (Y += "<tr>"),
                ...
                for (b = 0; b < 6; b++) {
                    for (Y += "<tr>", this.showWeekNumbers ? (Y += '<td class="week">' + i[b][0].week() + "</td>") : this.showISOWeekNumbers && (Y += '<td class="week">' + i[b][0].isoWeek() + "</td>"), 
                    cojoin = 0,
                    k = 0; k < 7; k++) {
                        var W = [];
                        i[b][k].isSame(new Date(), "day") && W.push("today"),
                            ...
                            i[b][k].isBefore(new Date(), "day") && W.push("off", "disabled"),
                ...
                if ("right" != t || this.endDate) {
                    ...
                    for (var o = this.timePicker24Hour ? 0 : 1, l = this.timePicker24Hour ? 23 : 12, h = o; h <= l; h++) {
                        ...
                        i && d.minute(59).isBefore(i) && (m = !0),
                            ...
                            c != a.hour() || m
                                ? (e += m ? '<option value="' + h + '" disabled="disabled" class="disabled">' + h + "</option>" : '<option value="' + h + '">' + h + "</option>")
                                : (e += '<option value="' + h + '" selected="selected">' + h + "</option>");
                    }
                    for (e += "</select> ", e += ': <select class="minuteselect">', h = 0; h < 60; h += this.timePickerIncrement) {
                        ...
                        (d = a.clone().minute(h)),
                            ...
                            a.minute() != h || m
                                ? (e += m ? '<option value="' + h + '" disabled="disabled" class="disabled">' + p + "</option>" : '<option value="' + h + '">' + p + "</option>")
                                : (e += '<option value="' + h + '" selected="selected">' + p + "</option>");
                    }
            ...
            move: function () {
                ...
                switch (
                    (this.parentEl.is("body") ||
                        ((i = { top: this.parentEl.offset().top - this.parentEl.scrollTop(), left: this.parentEl.offset().left - this.parentEl.scrollLeft() }), (n = this.parentEl[0].clientWidth + this.parentEl.offset().left)),
                    s)
                ) {
                    case "auto":
                        (a = this.element.offset().top + this.element.outerHeight() - i.top) + this.container.outerHeight() >= this.parentEl[0].scrollHeight &&
                            ((a = this.element.offset().top - this.container.outerHeight() - i.top), (s = "up"));
                        break;
                    case "up":
                        a = this.element.offset().top - this.container.outerHeight() - i.top;
                        break;
                    default:
                        a = this.element.offset().top + this.element.outerHeight() - i.top;
                }
                ...
                if ((this.container.toggleClass("drop-up", "up" == s), "left" == this.opens)) {
                    ...
                    r + o > e(window).width() ? this.container.css({ top: a, right: "auto", left: 9 }) : this.container.css({ top: a, right: o, left: "auto" });
                } else
                    "center" == this.opens
                        ? (t = this.element.offset().left - i.left + this.element.outerWidth() / 2 - r / 2) < 0
                            ? this.container.css({ top: a, right: "auto", left: 9 })
                            : t + r > e(window).width()
                            ? this.container.css({ top: a, left: "auto", right: 0 })
                            : this.container.css({ top: a, left: t, right: "auto" })
                        : (t = this.element.offset().left - i.left) + r > e(window).width()
                        ? this.container.css({ top: a, left: "auto", right: 0 })
                        : this.container.css({ top: a, left: t, right: "auto" });
            },
            show: function (t) {
                this.isShowing ||
                    ((this._outsideClickProxy = e.proxy(function (t) {
                        if(this.alwaysShowCalendars == false){
                            this.outsideClick(t);
                        }
                    }, this)),
                    e(document)
            ...
            clickPrev: function (t) {
                e(t.target).parents(".drp-calendar").hasClass("left") ? (this.leftCalendar.month.subtract(1, "month"), this.linkedCalendars && this.centerCalendar.month.subtract(1, "month") && this.rightCalendar.month.subtract(1, "month")) : this.rightCalendar.month.subtract(1, "month"),
                    this.updateCalendars();
            },
            clickNext: function (t) {
                e(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.month.add(1, "month") : e(t.target).parents(".drp-calendar").hasClass("center") ? this.centerCalendar.month.add(1, "month") : (this.rightCalendar.month.add(1, "month"), this.linkedCalendars && this.leftCalendar.month.add(1, "month") && this.centerCalendar.month.add(1, "month")),
                    this.updateCalendars();
            },
            hoverDate: function (t) {
                ...
                if (e(t.target).hasClass("available")) {
                    var a = e(t.target).attr("data-title"),
                        i = a.substr(1, 1),
                        s = a.substr(3, 1),
                        n = e(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.calendar[i][s] : e(t.target).parents(".drp-calendar").hasClass("center") ? this.centerCalendar.calendar[i][s] : this.rightCalendar.calendar[i][s],
                        r = this.leftCalendar,
                        rc = this.centerCalendar,
                        ...
                        this.container.find(".drp-calendar tbody td").each(function (t, a) {
                            if (!e(a).hasClass("week")) {
                                var i = e(a).attr("data-title"),
                                    s = i.substr(1, 1),
                                    h = i.substr(3, 1),
                                    c = e(a).parents(".drp-calendar").hasClass("left") ? r.calendar[s][h] : e(a).parents(".drp-calendar").hasClass("center") ? rc.calendar[s][h] : o.calendar[s][h];
            ...
            clickDate: function (t) {
                if (e(t.target).hasClass("available")) {
                    var a,
                        i = e(t.target).attr("data-title"),
                        s = i.substr(1, 1),
                        n = i.substr(3, 1),
                        r = e(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.calendar[s][n] : e(t.target).parents(".drp-calendar").hasClass("center") ? this.centerCalendar.calendar[s][n] : this.rightCalendar.calendar[s][n];
                    if (this.endDate || r.isBefore(this.startDate, "day")) {
                        if (this.timePicker) {
                            var o = parseInt(this.container.find(".left .hourselect").val(), 10);
                            this.timePicker24Hour || ("PM" === (a = this.container.find(".left .ampmselect").val()) && o < 12 && (o += 12), "AM" === a && 12 === o && (o = 0));
                        ...
                        !this.endDate && r.isBefore(this.startDate)
                            ...
                            : (this.timePicker &&
                                  ...
                                  this.timePicker24Hour || ("PM" === (a = this.container.find(".right .ampmselect").val()) && o < 12 && (o += 12), "AM" === a && 12 === o && (o = 0)),
                                  isNaN((l = parseInt(this.container.find(".right .minuteselect").val(), 10))) && (l = parseInt(this.container.find(".right .minuteselect option:last").val(), 10)),
                    ...
                    this.singleDatePicker && (this.setEndDate(this.startDate), !this.timePicker && this.autoApply && this.clickApply()), this.updateView(), t.stopPropagation(), this.element.trigger("clickDate.daterangepicker", this);
            ...
            clickApply: function (t) {
                $("#exampleModaltest").modal("show"), this.hide(), this.element.trigger("apply.daterangepicker", this);
            },
            ...
            monthOrYearChanged: function (t) {
                var a = e(t.target).closest(".drp-calendar").hasClass("left"),
                    i = this.container.find(".drp-calendar." + (a ? "left" : a ? "center" : "right")),
                ...
                a || ((n < this.startDate.year() || (n == this.startDate.year() && s < this.startDate.month())) && ((s = this.startDate.month()), (n = this.startDate.year()))),
                    ...
                    a
                        ...
                        :
                        a ? (this.centerCalendar.month.month(s).year(n), this.linkedCalendars && (this.rightCalendar.month = this.centerCalendar.month.clone().add(1, "month")))
